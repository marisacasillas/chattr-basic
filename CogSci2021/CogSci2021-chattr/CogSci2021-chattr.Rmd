...
The Tsimane' recordings were manually annotated for one minute, every 30 minutes, starting in the 34th minute. Annotations included (a) when speech was occurring and (b) what type of speaker produced it (i.e., target child, a nearby woman/man/other child, or other noise sources). Prior analysis of this dataset shows comparably low rates of directed speech to the Tseltal and Yélî Dnye datasets, again with a high proportion of directed input coming from other children. We therefore expected to find that: (1) turn-taking rates are overall similar to what we found in the random samples of the other two communities, (2) turn-taking sequences involving other children are comparable or more frequent than found in the random samples of the other two communities, and (3) interactional sequences involving other children increase with age.
